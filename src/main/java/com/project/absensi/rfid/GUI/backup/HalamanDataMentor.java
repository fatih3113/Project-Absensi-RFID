 ...
 */
public class HalamanDataMentor extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(HalamanDataMentor.class.getName());

    /** Creates new form HalamanScan */
    public HalamanDataMentor() {
        initComponents();
    ...
    private void tambahListenerTabel() {
        ...
        @Override
            public void valueChanged(javax.swing.event.ListSelectionEvent e) {
                ...
                boolean adaBarisDipilih = jTable1.getSelectedRow() != -1;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "Tempat, Tanggal lahir", "Program Kursus"
            }
        ));
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new HalamanDataMentor().setVisible(true));
    }
