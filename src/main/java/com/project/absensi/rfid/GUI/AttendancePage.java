...
public class AttendancePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        autoScaledLabel1 = new com.project.absensi.rfid.palette.AutoScaledLabel();
        ...
        autoScaledLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Logo metro (1).jpeg"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(autoScaledLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private com.project.absensi.rfid.palette.AutoScaledLabel autoScaledLabel1;
            ...
            SwingUtilities.invokeLater(() -> {
                if (s != null) {
                    logService.simpanLog(hashedUid, Settings.prefs.get("LAST_STATUS", Settings.statusAbsen));
                        jLabel3.setText(I18nService.get("ui.label.name")+": " + s.getNamaLengkap() + "");
                        jLabel4.setText(I18nService.get("ui.label.id")+": " + EncryptionUtils.decrypt(s.getNis()));
                        jLabel5.setText(I18nService.get("ui.label.dept")+": " + s.getProgram());
